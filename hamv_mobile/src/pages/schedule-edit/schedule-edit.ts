...
export class ScheduleEditPage {
  ...
  buttons: Array<Object> = [
    {
      value: 1,
      text: 'SCHEDULE_REPEAT_TIME.MON',
    },
    {
      value: 2,
      text: 'SCHEDULE_REPEAT_TIME.TUE',
    },
    {
      value: 3,
      text: 'SCHEDULE_REPEAT_TIME.WED',
    },
    {
      value: 4,
      text: 'SCHEDULE_REPEAT_TIME.THU',
    },
    {
      value: 5,
      text: 'SCHEDULE_REPEAT_TIME.FRI',
    },
    {
      value: 6,
      text: 'SCHEDULE_REPEAT_TIME.SAT',
    },
    {
      value: 7,
      text: 'SCHEDULE_REPEAT_TIME.SUN',
    },
  ];
