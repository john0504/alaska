...
@Component({
  ...
  providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => TitleText), multi: true }],
  encapsulation: ViewEncapsulation.None,
})
export class TitleText extends UIComponentBase {
  title: string = '';
  logic: ReadOnlyLogic;
