...
@Component({
    selector: 'simple-text-toggle',
    templateUrl: 'simple-text-toggle.html',
    providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => SimpleTextToggle), multi: true }],
    encapsulation: ViewEncapsulation.None,
})
export class SimpleTextToggle extends UIComponentBase {
    title: string = '';
    logic: ToggleLogic;
    ...
    constructor(
        ...
        super(ims, 'simple-text-toggle', null);
