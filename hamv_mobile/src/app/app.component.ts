...
export class MyApp implements OnInit, OnDestroy {
  ...
  appPages: Array<any> = [
    { title: 'APP.HOME', component: 'LargeListPage', icon: "icon-home" },
    { title: 'APP.MY_GROUPS', component: 'MyGroupsPage', icon: "icon-group" },
    { title: 'APP.SETTINGS', component: 'SettingsPage', icon: "icon-setting" },
  ];
  ...
  private registerComponents() {
    ...
    this.cp.registerComponent('title-text', TitleText);
    this.cp.registerComponent('color-text', ColorText);
    this.cp.registerComponent('toggle', SimpleToggle);
    this.cp.registerComponent('text-toggle', SimpleTextToggle);
